...
class TabuSearchApriori(TabuSearch):
    ...
    def __init__(self, init_sol=None, problem=None, delta=None, max_iter=None, constraints=None,
        ...
        super().__init__(init_sol=init_sol, problem=problem, delta=delta, max_iter=max_iter, constraints=constraints, tabu_list_max_length=tabu_list_max_length, max_loops=max_loops)
